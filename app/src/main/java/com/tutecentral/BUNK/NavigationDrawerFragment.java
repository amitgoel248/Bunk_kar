...
public class NavigationDrawerFragment extends Fragment implements adapter_nav.ClickListener{
    ...
    public static List<Information_nav> getdata()
    {
        ...
        int[] icons={R.drawable.ic_action_view_as_list,R.drawable.ic_action_labels,R.drawable.ic_action_go_to_today,R.drawable.ic_action_about,R.drawable.ic_action_person};
        String[] titles={"Today's Schedule","Subjects","Percentage","About","Developers"};
    ...
    public String readFromPreferences(FragmentActivity context, String preferenceName, String defaultValue)
    {
        SharedPreferences sharedPreferences=context.getSharedPreferences(PREF_FILE_NAME,context.MODE_PRIVATE);
